...
a = Analysis(
    ['manage.py'],
    pathex=['/home/sai/Desktop/rasperri_twoch_interlink'],
    binaries=[],
    ...
    hooksconfig={},
    runtime_hooks=[],
    excludes=['libgcc_s.so.1', 'libmount.so.1'],
...
exe = EXE(
    ...
    upx=True,
    console=True,
    icon='/home/sai/Desktop/rasperri_twoch_interlink/four_channel/app/static/images/Gauge.ico',
