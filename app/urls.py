...
from .views import comport,login,data,measure_data,backup,delete_measure_data,spcCharts,get_parameters,get_parameter_value,open_rustdesk
from .views import keyboard,customer,shift_redirect_status,save_shift_redirect,set_clear_flag,reset_clear_flag,interlink,mssql_status_api
...
urlpatterns = [
    ...
    path("mssql-status/", mssql_status_api, name="mssql_status"),
